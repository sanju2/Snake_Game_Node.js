export default class Snake {
    ...
    constructor(scene) {
        ...
        this.body = [];
        this.body.push(this.scene.add.rectangle(the.scene.game.config.width / 2, this.scene.game.config.height / 2, this.tileSize, this.tileSize, 0xff0000).setOrigin(0));
